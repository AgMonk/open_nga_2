    ...
    <div>
      <el-form>
        <el-form-item label="主题列表">
          ...
          <el-button @click="thread" type="primary">发送</el-button>
        </el-form-item>
        <el-form-item label="主题详情">
          <el-input v-model="tid"/>
          <el-button @click="read" type="primary">发送</el-button>
        </el-form-item>
...
import {requestUnity, searchByUser} from "@/assets/request/nga-request";
